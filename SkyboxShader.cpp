...
bool skyshader::AddShader(GLenum ShaderType)
{
    std::string s;
...
void skyshader::Enable()
{
    glUseProgram(m_shaderProg);
}


GLint skyshader::GetUniformLocation(const char* pUniformName)
{
...
GLint skyshader::GetAttribLocation(const char* pAttribName)
{
